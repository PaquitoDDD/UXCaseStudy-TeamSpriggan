          ...
          <div className="h-[566px] overflow-clip relative w-[1132px]">
            <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Inter_18pt:Light',sans-serif] h-[538px] justify-center leading-[0] left-[565.5px] not-italic text-[72px] text-center text-white top-[268.6px] w-[915px]">
              <p className="leading-[normal]">
                Conocido por su meticulosa atención al detalle, Japón ofrece cafés refinados con técnicas de preparación únicas y sabores delicados
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col gap-[120px]">
          ...
          <div className="flex items-center justify-between gap-[60px]">
            ...
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#f5e6d3] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                El café llegó a Japón en el siglo XVII a través de comerciantes holandeses. Aunque tardó en popularizarse, hoy en día Japón es conocido mundialmente por su cultura del café especializado y sus kissaten tradicionales.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-[60px]">
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#e3f2fd] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                Japón importa granos de alta calidad y los tuesta con precisión. Son famosos por el método de goteo lento, el sifón y la preparación meticulosa que resalta los sabores más sutiles del café.
              </p>
            </div>
            <div className="h-[450px] w-[675px] flex-shrink-0">
          ...
          <div className="flex items-center justify-between gap-[60px]">
            ...
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#e8f8f3] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                El café japonés se caracteriza por su claridad y balance perfecto. Con notas limpias y brillantes, los baristas japoneses resaltan la acidez delicada y los sabores florales con una precisión incomparable.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#f3d4b0] rounded-[15px] relative overflow-hidden">
            <div className="content-stretch flex gap-[148px] items-center justify-center px-[33px] py-12 relative rounded-[inherit]">
              <ProductCard
                image={imgProduct1}
                title="Tokyo Blend"
                onClick={() => console.log('Tokyo Blend details')}
              />
              <ProductCard
                image={imgProduct2}
                title="Kyoto Drip"
                onClick={() => console.log('Kyoto Drip details')}
              />
              <ProductCard
                image={imgProduct3}
                title="Osaka Select"
                onClick={() => console.log('Osaka Select details')}
              />
            </div>
            <div
              aria-hidden="true"
