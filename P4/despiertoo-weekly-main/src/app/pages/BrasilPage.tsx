          ...
          <div className="h-[566px] overflow-clip relative w-[1132px]">
            <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Inter_18pt:Light',sans-serif] h-[538px] justify-center leading-[0] left-[565.5px] not-italic text-[72px] text-center text-white top-[268.6px] w-[915px]">
              <p className="leading-[normal]">
                Considerada la capital mundial del café, Brasil ofrece una variedad de sabores suaves con notas dulces y
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col gap-[120px]">
          ...
          <div className="flex items-center justify-between gap-[60px]">
            ...
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#f5e6d3] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                El café llegó a Brasil en 1727, introducido desde la Guayana Francesa por el teniente coronel Francisco
                de Melo Palheta, quien supuestamente contrabandeó las primeras semillas. Plantado inicialmente en Pará,
                se extendió rápidamente hacia el sureste, convirtiéndose en el motor económico del país y principal
                exportador mundial hacia 1830.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-[60px]">
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#e3f2fd] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                Brasil es el mayor productor mundial de café, destacando principalmente por sus variedades de Arábica
                (80% de la producción), reconocidos por su sabor dulce, cuerpo medio, baja acidez y notas achocolatadas
                o de frutos secos. Las variedades más cultivadas incluyen Bourbon, Mundo Novo, Catuaí, Acaia e Icatu.
              </p>
            </div>
            <div className="h-[450px] w-[675px] flex-shrink-0">
          ...
          <div className="flex items-center justify-between gap-[60px]">
            ...
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#e8f8f3] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                El café de Brasil se caracteriza por un cuerpo denso, baja acidez y un perfil de sabor suave y
                equilibrado. Sus notas principales evocan dulzor: destacan los matices de chocolate con leche, caramelo,
                azúcar moreno y frutos secos (como nueces o almendras). Los sabores varían ligeramente según la variedad
                del grano arábica (que representa el 80% de su producción).
              </p>
            </div>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="bg-[#f3d4b0] rounded-[15px] relative overflow-hidden">
            <div className="content-stretch flex gap-[148px] items-center justify-center px-[33px] py-12 relative rounded-[inherit]">
              <ProductCard
                image={imgProduct1}
                title="Sao Paulo Crema"
                onClick={() => console.log('Sao Paulo Crema details')}
              />
              <ProductCard
                image={imgProduct2}
                title="Amazonia Cacao"
                onClick={() => console.log('Amazonia Cacao details')}
              />
              <ProductCard
                image={imgProduct3}
                title="Salvador Mix"
                onClick={() => console.log('Salvador Mix details')}
              />
            </div>
            <div
              aria-hidden="true"
