          ...
          <div className="h-[566px] overflow-clip relative w-[1132px]">
            <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Inter_18pt:Light',sans-serif] h-[538px] justify-center leading-[0] left-[565.5px] not-italic text-[72px] text-center text-white top-[268.6px] w-[915px]">
              <p className="leading-[normal]">
                Cuna del espresso, Italia ha perfeccionado el arte del café con una tradición centenaria de sabor intenso y carácter inigualable
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col gap-[120px]">
          ...
          <div className="flex items-center justify-between gap-[60px]">
            ...
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#f5e6d3] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                El café llegó a Italia en el siglo XVI desde Oriente. Venecia fue el primer puerto europeo en comercializarlo. A principios del siglo XX, Italia revolucionó el mundo del café con la invención de la máquina de espresso.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-[60px]">
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#e3f2fd] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                Italia es sinónimo de espresso: intenso, cremoso y servido en pequeñas dosis. También son famosos el cappuccino matutino y el macchiato. Los tuestes oscuros son la firma italiana.
              </p>
            </div>
            <div className="h-[450px] w-[675px] flex-shrink-0">
          ...
          <div className="flex items-center justify-between gap-[60px]">
            ...
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#e8f8f3] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                El café italiano se caracteriza por su cuerpo robusto, crema espesa y sabor intenso. Con notas de cacao oscuro, frutos secos tostados y un amargor equilibrado que define la experiencia del espresso perfecto.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#f3d4b0] rounded-[15px] relative overflow-hidden">
            <div className="content-stretch flex gap-[148px] items-center justify-center px-[33px] py-12 relative rounded-[inherit]">
              <ProductCard
                image={imgProduct1}
                title="Roma Intenso"
                onClick={() => console.log('Roma Intenso details')}
              />
              <ProductCard
                image={imgProduct2}
                title="Milano Classico"
                onClick={() => console.log('Milano Classico details')}
              />
              <ProductCard
                image={imgProduct3}
                title="Napoli Forte"
                onClick={() => console.log('Napoli Forte details')}
              />
            </div>
            <div
              aria-hidden="true"
