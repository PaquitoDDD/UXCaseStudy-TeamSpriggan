    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      >
        <div className="absolute inset-0">
          <img
            alt="Alemania Coffee Background"
          ...
          <div className="h-[566px] overflow-clip relative w-[1132px]">
            <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Inter_18pt:Light',sans-serif] h-[538px] justify-center leading-[0] left-[565.5px] not-italic text-[72px] text-center text-white top-[268.6px] w-[915px]">
              <p className="leading-[normal]">
                Pionera en la cultura del café filtrado, Alemania combina precisión técnica con una apreciación profunda por la calidad y el sabor
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col gap-[120px]">
          ...
          <div className="flex items-center justify-between gap-[60px]">
            ...
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#f5e6d3] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                El café llegó a Alemania en el siglo XVII y rápidamente se convirtió en una bebida popular. Las cafeterías alemanas se establecieron como centros de discusión intelectual y social, creando una rica tradición cafetera.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-[60px]">
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#e3f2fd] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                Alemania es conocida por su café filtrado meticulosamente preparado. El método de goteo y el café de filtro manual son especialmente apreciados, destacando la claridad y los sabores complejos del grano.
              </p>
            </div>
            <div className="h-[450px] w-[675px] flex-shrink-0">
          ...
          <div className="flex items-center justify-between gap-[60px]">
            ...
            <div className="flex flex-col gap-[40px] max-w-[601px] justify-center bg-[#e8f8f3] p-12 rounded-lg">
              ...
              <p className="font-['Inter_18pt:Light',sans-serif] text-[28px] leading-[normal] text-black">
                El café alemán se caracteriza por su precisión y balance. Los tuestes medios revelan sabores limpios con notas de caramelo, frutos secos y una acidez bien definida que resalta la calidad del grano.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#f3d4b0] rounded-[15px] relative overflow-hidden">
            <div className="content-stretch flex gap-[148px] items-center justify-center px-[33px] py-12 relative rounded-[inherit]">
              <ProductCard
                image={imgProduct1}
                title="Berlin Blend"
                onClick={() => console.log('Berlin Blend details')}
              />
              <ProductCard
                image={imgProduct2}
                title="Hamburg Filter"
                onClick={() => console.log('Hamburg Filter details')}
              />
              <ProductCard
                image={imgProduct3}
                title="Munich Roast"
                onClick={() => console.log('Munich Roast details')}
              />
            </div>
            <div
              aria-hidden="true"
